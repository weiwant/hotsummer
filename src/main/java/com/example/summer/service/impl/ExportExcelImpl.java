...
public class ExportExcelImpl implements ExportExcelService {
    ...
    @Override
    public ExcelFormat getContentInScopeAll(String startYear, String endYear) {
        ...
        String sheetName = "教学工作量";
        //返回查询到的记录
        List<TeachingWorkloadStatistics> list = excelDao.searchInScopeAccurateAll(startYear, endYear);
