<template>
  <div class="componentSubsection category">
    ...
    <div class="addNew">
        ...
        <td>类别:    </td>
        <td>
          <input type="radio" id="excellentclass" value="卓越班选拔面试 " v-model="category" >
          <label for="excellentclass">卓越班选拔面试 </label>
          <input type="radio" id="Campus open day" value="校园开放日咨询   " v-model="category" >> 
          <label for="Campus open day">校园开放日咨询</label>
          <input type="radio"  id="Sub major" value=" 本科生分专业宣讲 " v-model="category" >
          <label for="Sub major">本科生分专业宣讲 </label>
          <input type="radio"  id="Transfer major" value=" 转专业面试 " v-model="category" >
           <label for="Transfer majorr"> 转专业面试 </label>
          <input type="radio"  id="Undergraduate enrollment consultation" value=" 本科生招生咨询 " v-model="category" >
           <label for="Undergraduate enrollment consultation">本科生招生咨询  </label>
          <input type="radio"  id="Various reviews" value="各类评审 " v-model="category" > 
           <label for="Various reviewsr">各类评审 </label>
          <input type="radio"  id="excellentclass" value="其他 " v-model="category" > 
